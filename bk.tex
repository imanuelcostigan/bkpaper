...
see, this changes the resulting PDE representation of the derivative's price.\sidenote{
Even if we use the hedging strategy specified by B\&K, I will demonstrate in a later
section that it is impossible to arrive at B\&K's PDE.}
